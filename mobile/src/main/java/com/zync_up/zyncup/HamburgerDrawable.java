...
public class HamburgerDrawable extends Drawable implements Animatable
{
    ...
    public HamburgerDrawable(Context context, int color, Stroke stroke, int scale,
    ...
    private HamburgerDrawable(int color, Stroke stroke, long transformDuration, long pressedDuration,
                              int width, int height, float iconWidth, float circleRadius, float strokeWidth,
                              float dip1)
    {
        this.dip1 = dip1;
        this.dip2 = dip1 * 2;
    ...
    private Property<HamburgerDrawable, Float> transformationProperty
        = new Property<HamburgerDrawable, Float>(Float.class, "transformation")
    {
        @Override
        public Float get(HamburgerDrawable object)
        {
            return object.getTransformationValue();
        }

        @Override
        public void set(HamburgerDrawable object, Float value)
        {
            object.setTransformationValue(value);
        }
    };

    private Property<HamburgerDrawable, Float> pressedProgressProperty
        = new Property<HamburgerDrawable, Float>(Float.class, "pressedProgress")
    {
        @Override
        public Float get(HamburgerDrawable object)
        {
    ...
    private final class MaterialMenuState extends ConstantState {
        ...
        {
            HamburgerDrawable drawable = new HamburgerDrawable(
